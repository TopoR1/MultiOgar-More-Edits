...
module.exports = class BotPlayer extends PlayerTracker{
    ...
    decide(cell) {
        ...
        let result = new Vec2(0, 0); // For splitting
        for (let i = 0; i < this.viewNodes.length; i++) {
            ...
            let displacement = new Vec2(check.position.x - cell.position.x, check.position.y - cell.position.y);
